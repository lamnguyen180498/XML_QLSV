...
<html>
    ...
    <body class="body">
        <div class="add">
        <h1 class="center">Sửa sinh viên </h1>
        <br/> <br/>
        <form method="post" action="student-edit.php?id=<?php echo $data['sv_id']; ?>">
            <table width="80%" border="1" cellspacing="0" cellpadding="10" class="m-auto">
                <tr>
                    <td>Name</td>
                    <td>
             ...
             <a href="student-list.php" class="back">Trở về</a>
        </form>
        </div>
    </body>
</html>
